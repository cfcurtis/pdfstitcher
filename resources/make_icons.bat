...
%inkscape% -o stitcher-icon.iconset/icon_256x256.png    -w  256 -h  256  stitcher-icon.svg
%inkscape% -o stitcher-icon.iconset/icon_256x256@2x.png -w  512 -h  512  stitcher-icon.svg
%inkscape% -o stitcher-icon.iconset/icon_512x512.png    -w  512 -h  512  stitcher-icon.svg
%inkscape% -o stitcher-icon.iconset/icon_512x512@2x.png -w 1024 -h 1024  stitcher-icon.svg

@REM on mac: iconutil -c icns stitcher-icon.iconset
