...
class AbstractLayerFilter:
        ...
        def run(self):
            """
            Performs the layer and line property modifications
            Returns an iterator of page_range (int), progress (True at the end of each cycle), and the resulting pikepdf.Pdf document
            If you need just the pikepdf document, use .run()[-1]
            """
