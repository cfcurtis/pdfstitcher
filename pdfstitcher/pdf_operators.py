...
ops = {
    ...
    'SCN': ('state','stroke'), # (PDF 1.2) Set color for stroking operations (ICCBased and special color spaces)
    'scn': ('state','nonstroke'), # (PDF 1.2) Set color for nonstroking operations (ICCBased and special color spaces)
